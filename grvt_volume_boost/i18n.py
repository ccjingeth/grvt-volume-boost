...
_T: dict[str, dict[str, str]] = {
    "en": {
        ...
        "session.missing_session_key": "{name} missing grvt_ss_on_chain (re-login via QR or API)",
        ...
        "setup.paste_session": "Paste Session",
        "setup.env_title": "API Mode (.env)",
        "setup.env_path": ".env location: {path}",
        "setup.env_open": "Open .env",
        "setup.env_open_dir": "Open Folder",
        "setup.env_open_failed": "Failed to open path",
        "setup.env_create_failed": "Failed to create .env",
        "setup.close": "Close",
        ...
        "setup.paste_title": "Paste Session Data",
        "setup.paste_body": "Paste a full storage state JSON, or key-value lines.\n\nExamples:\n- grvt_ss_on_chain=...\n- gravity=...\n- account_id=... (optional)\n- chain_sub_account_id=... (optional)\n\nTip: You can also paste the full JSON exported from your browser storage state.",
        "setup.paste_empty": "No data provided.",
        "setup.paste_invalid": "Invalid session data: {err}",
        "setup.paste_saved": "Session saved for Account {n}.",
        "setup.paste_saved_title": "Session Saved",
        "setup.paste_warn_title": "Session Saved with Warning",
        "setup.paste_missing_cookie": "Session saved, but no gravity cookie was provided.\n\nTrading and data queries may fail. Provide the gravity cookie or re-login via QR.",
    ...
    "zh": {
        ...
        "session.missing_session_key": "{name} 缺少 grvt_ss_on_chain（请重新扫码登录或使用 API）",
        ...
        "setup.paste_session": "粘贴会话",
        "setup.env_title": "API 模式（.env）",
        "setup.env_path": ".env 位置：{path}",
        "setup.env_open": "打开 .env",
        "setup.env_open_dir": "打开目录",
        "setup.env_open_failed": "无法打开路径",
        "setup.env_create_failed": "创建 .env 失败",
        "setup.close": "关闭",
        ...
        "setup.paste_title": "粘贴会话数据",
        "setup.paste_body": "可粘贴完整的 storage state JSON，或 key=value 文本。\n\n示例：\n- grvt_ss_on_chain=...\n- gravity=...\n- account_id=...（可选）\n- chain_sub_account_id=...（可选）\n\n提示：也可以直接粘贴浏览器导出的完整 JSON。",
        "setup.paste_empty": "未提供任何数据。",
        "setup.paste_invalid": "会话数据无效：{err}",
        "setup.paste_saved": "账号 {n} 会话已保存。",
        "setup.paste_saved_title": "会话已保存",
        "setup.paste_warn_title": "会话已保存（有警告）",
        "setup.paste_missing_cookie": "会话已保存，但未提供 gravity Cookie。\n\n交易和数据请求可能失败。请补充 gravity Cookie 或重新扫码登录。",
